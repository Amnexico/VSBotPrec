...
this.use(async (ctx, next) => {
  ...
  return next();
   ...
   // ✅ NUEVOS COMANDOS DE DIAGNÓSTICO Y TEXTO MASIVO:
   ...
   // ✅ HANDLER MEJORADO PARA IMPORTACIÓN MASIVA DE DOCUMENTOS CSV:
   this.on('document', adminCommands.procesarArchivoCSV);
   
   // ✅ HANDLER PARA IMPORTACIÓN MASIVA POR TEXTO:
   this.on('text', adminCommands.procesarTextoMasivo);
