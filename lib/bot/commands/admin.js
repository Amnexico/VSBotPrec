...
const ayudaAdmin = async (ctx) => {
  ...
  try {
    ...
    const mensaje1 = `📋 COMANDOS DE ADMINISTRADOR - PARTE 1/4
...
- /emailblast Ofertas|Hola, ofertas de la semana`;
    ...
    const mensaje2 = `📋 COMANDOS DE ADMINISTRADOR - PARTE 2/4
...
/recuperarproducto ASIN - Recuperar producto eliminado`;
    ...
    // MENSAJE 3: IMPORTACIÓN Y DIAGNÓSTICO (SIN MARKDOWN)
    const mensaje3 = `📋 COMANDOS DE ADMINISTRADOR - PARTE 3/4
...
- /testearalerta B0DCVYS9FQ`;
    ...
    // MENSAJE 4: FLUJO DE TRABAJO (SIN MARKDOWN)
    const mensaje4 = `📋 COMANDOS DE ADMINISTRADOR - PARTE 4/4

📅 FORMATO FECHAS: DD/MM/YYYY (ej: 28/08/2025)

🚀 FLUJO PARA OFERTAS:
1. /marcarrobot B0DCVYS9FQ - Marcar como robot aspirador
2. El sistema detecta automáticamente bajadas de precio
3. Se publican ofertas en canales
...
- /ayudaanalytics - Ayuda analytics detallada

✅ Ayuda completa enviada en 4 partes`;
