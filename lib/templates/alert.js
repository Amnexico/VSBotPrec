...
https://www.amazon.es/dp/${this.a'use strict';
class Alert {
  constructor(product) {
    ...
    this.affiliateUrl = product.affiliateUrl; // NUEVO: URL con tag de afiliado
        ...
        reply_markup: {
          inline_keyboard: [
            [{
              ...
              url: this.affiliateUrl || `https://www.amazon.es/dp/${this.asin}?tag=vacuumspain-21`
            }],
            [{
