...
class Alert {
  constructor(product) {
    ...
    this.isGroupAlert = product.isGroupAlert || false;
    this.groupName = product.groupName;
    this.actualVariantASIN = product.actualVariantASIN;
    this.actualVariantColor = product.actualVariantColor;
    this.userVariantColor = product.userVariantColor;
    this.isCrossVariant = product.isCrossVariant || false;
  }
