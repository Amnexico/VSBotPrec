    ...
    try {
      ...
      if (this.useResend) {
        const result = await this.resend.emails.send({
          from: process.env.EMAIL_FROM || 'alerts@ofertron.com',
          to: email,
          subject: subject,
          html: htmlContent,
          text: textContent
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Recibiste este email porque configuraste alertas de precio en Ofertrón.</p>
  ...
  createAlertText(alertData) {
    const isPriceDrop = alertData.changeType === 'price_drop';
    let text = `🤖 OFERTRÓN - ${isPriceDrop ? 'Bajada de precio' : 'Stock disponible'}\n\n`;
...
<body>
  <div class="container">
    <h2>🤖 OFERTRÓN by Vacuum Spain - Confirma tu email</h2>
