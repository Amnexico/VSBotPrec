...
if (imageUrl) {
 ...
 async forcePublishOffer(asin) {
  ...
  try {
    ...
    if (product?.image) {
      ...
      // Si es una imagen de Amazon, obtener versión de mayor resolución
 ...
 formatOfferMessage(data) {
  ...
  // Solo mostrar mínimo si es histórico o de 30 días
  ...
  message += `*📊 Historial de Precios: @ofertronbot*`;
