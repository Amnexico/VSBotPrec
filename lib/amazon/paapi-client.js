...
class PaapiClient {
  ...
  // Crear payload con soporte para vendedor
  createPayload(asin) {
    return {
      ItemIds: [asin],
      Resources: [
        ...
        'Offers.Listings.Condition',        // NUEVO
        'Offers.Listings.MerchantInfo',     // NUEVO
        'Offers.Listings.DeliveryInfo',     // NUEVO
  ...
  // Parser mejorado para extraer información incluyendo vendedor
