          ...
          res.on('end', async () => {
            ...
            try {
              ...
              if (res.statusCode === 200 && response.ItemsResult?.Items) {
                ...
                // Tracking de API call exitosa
                const responseTime = Date.now() - startTime;
                const AnalyticsService = require('../services/analytics-service');
                await AnalyticsService.trackApiCall(asin, true, responseTime);
                ...
                // Tracking de error de API
                const AnalyticsService = require('../services/analytics-service');
                await AnalyticsService.trackApiCall(asin, false);
