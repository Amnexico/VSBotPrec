...
class PaapiClient {
  constructor() {
    ...
    console.log('AMAZON_TRACKING_TAG:', process.env.AMAZON_TRACKING_TAG ? 'SET' : 'NOT SET');
    console.log('AWS_ACCESS_KEY_ID:', process.env.AWS_ACCESS_KEY_ID ? 'SET' : 'NOT SET');
    console.log('AWS_SECRET_ACCESS_KEY:', process.env.AWS_SECRET_ACCESS_KEY ? 'SET' : 'NOT SET');
    console.log('===================================');
    
    // Configuración PA-API con fallback temporal para debugging
    this.accessKey = process.env.AMAZON_ACCESS_KEY || process.env.AWS_ACCESS_KEY_ID;
    this.secretKey = process.env.AMAZON_SECRET_KEY || process.env.AWS_SECRET_ACCESS_KEY;
